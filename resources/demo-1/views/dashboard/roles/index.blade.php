            ...
            <div class="card h-md-100">
                ...
                <div class="card-body d-flex flex-center">
                    ...
                    <button type="button" class="btn btn-clear d-flex flex-column flex-center" id="add-role-btn" data-bs-toggle="modal" data-bs-target="#kt_modal_add_role">
                        <!--begin::Illustration-->
                        <img src="{{ asset('dashboard-assets/demo-1/media/illustrations/sketchy-1/4.png') }}" alt="" class="mw-100 mh-150px mb-7">
                        <!--end::Illustration-->
                        <!--begin::Label-->
        ...
        <div class="modal-dialog modal-dialog-centered mw-750px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 my-7">
                    <!--begin::Form-->
                    <form id="role_form_update" data-form-type="update" class="form fv-plugins-bootstrap5 fv-plugins-framework submitted-form" method="POST" data-redirection-url="/dashboard/roles" data-trailing="_edit" >
                        @csrf
                        @method('PUT')
                        <!--begin::Scroll-->
