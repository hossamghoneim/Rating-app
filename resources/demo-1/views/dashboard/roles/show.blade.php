                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('dashboard.roles.index') }}"
                           class="text-muted text-hover-primary">{{ __("Role data") }}</a>
                    </li>
                    <!-- end   :: Item -->
                </ul>
                <!-- end   :: Breadcrumb -->
                ...
                <div class="modal-dialog modal-dialog-centered mw-750px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 my-7">
                            <!--begin::Form-->
                            <form id="role_form_update" data-form-type="update" class="form fv-plugins-bootstrap5 fv-plugins-framework submitted-form" method="POST" data-redirection-url="/dashboard/roles/{{ $role['id'] }}" data-trailing="_edit" >
                            @csrf
                            @method('PUT')
                            <!--begin::Scroll-->
            ...
            <div class="card card-flush mb-6 mb-xl-9">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700" >
                        ...
                        <div class="d-flex flex-stack flex-wrap mb-15">
                            ...
                            <!-- begin :: Header -->
                            <div>
                                <h2 class="d-flex align-items-center">{{ __("Admins Assigned") }}
                                    <span class="text-gray-700 fs-6 mx-5">( {{ $role->admins->count() }} )</span>
                                </h2>
                            </div>
                            <!-- end   :: Header -->
                            ...
                            <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0 d-none">
                                ...
                                <input type="text" data-kt-docs-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __("Search ...") }}">
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/role_admins.js') }}"></script>
