...
var KTWidgets = function () {
    ...
    var initStatisticsWidget3 = function() {
        ...
        [].slice.call(charts).map(function(element) {
            ...
            var options = {
                ...
                xaxis: {
                    categories: ['Very ', 'Mar', 'Apr', 'May', 'Jun', 'Jul'],
                    axisBorder: {
                        show: false,
                    },
                    axisTicks: {
    ...
    var initChartsWidget2 = function() {
        ...
        var initChart = function() {
            ...
            var secondaryColor = KTUtil.getCssVariableValue('--kt-gray-300');
            // Specify individual colors for each category
            var categoryColors = ['#1B95E8', '#8DC53C', '#F59230', '#C23735'];
            ...
            var options = {
                ...
                xaxis: {
                    categories: ['VERY GOOD', 'GOOD', 'ACCEPTABLE', 'POOR'],
                    axisBorder: {
                        show: false,
                    },
                    axisTicks: {
                ...
                colors: categoryColors, // Use the specified colors
                grid: {
                    borderColor: borderColor,
                    strokeDashArray: 4,
                    yaxis: {
