    ...
    var handleEditRows = () => {
        ...
        editButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                $("#color_inp").val(data.color);
                $("#model_year_inp").val(data.model_year);
                $("#username_inp").val(data.username);
                $("#board_registration_type_inp").val(data.board_registration_type);
                $("#user_identity_inp").val(data.user_identity);
                $("#contract_number_inp").val(data.contract_number);
                $("#cic_inp").val(data.cic);
                $("#certificate_status_inp").val(data.certificate_status);
                $("#vehicles_count_inp").val(data.vehicles_count);
                $("#product_inp").val(data.product);
                $("#installments_count_inp").val(data.installments_count);
                $("#late_days_count_inp").val(data.late_days_count);
                $("#city_inp").val(data.city);
                $("#employer_inp").val(data.employer);
