        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            ajax: {
                data: function () {
                    ...
                    datatable.DataTable().ajax.url(`/dashboard/role/${roleId}/admins?page=${info.page + 1}&per_page=${info.length}`);
                }
            },
            columns: [
                {data: 'id'},
                    ...
                    render: function (data, type, row) {
                        ...
                        if (!( row.id == 1 || row.id == currentUserId ))
                        {
                            deleteBtn = `<div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3 d-flex justify-content-between delete-row" data-row-id="${row.id}" data-type="${__('admin')}">
                                                    <span> ${__('Delete')} </span>
